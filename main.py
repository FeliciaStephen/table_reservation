...
class _page():
    ...
    def BOOK_TABLE(self):
        ...
        elif user_details[2].isnumeric() == False:
    ...
    def cancel_table_window(self):
        ...
        c_win.geometry("350x350")
        c_win.configure(bg="black")
        
        tt = '''Only admin can cancel a table!!
        contact +91 73058 68781 to cancel your table 
          (must be made atleast 2 hours in advance)'''
        label_text = Label(c_win, text = tt, font=("Lucida Bright",9),fg="red",bg="black")
